...
cols <- c("Model","OutYtm","OutRelPrice","OutDurW","OutMatW","InYtm","InRelPrice","InDurW","InMatW","Tension","Curvature")
cols1 <- c("outYtm","outRelPrice","outDurW","outMatW","inYtm","inRelPrice","inDurW","inMatW","tension","curvature")
rows <- c("NSS","KR")
...
tit1 <- c("Yield RMSE","Relative Pricing RMSE","Duration Weighted RMSE","Maturity Weighted RMSE")
tit2 <- c("YTM RMSE (BPS)","Relative Pricing RMSE (BPS)","Duration Weighted RMSE (BPS)","Maturity Weighted RMSE (BPS)")
...
grid.arrange(f_plot2(buckets,col1[1],col2[1],tit1[1],tit2[1]),f_plot2(buckets,col1[2],col2[2],tit1[2],tit2[2]),
             ...
             nrow=2,ncol=2,top=textGrob("Out-of-sample pricing errors for different maturities",gp=gpar(fontsize=15,font=1)),
